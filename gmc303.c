...
s8 gmc303_burst_read(u8 u8Addr, u8* pu8Data, u8 u8Len){
	...
	if(pGMC303Bus == NULL){
		...
		comRslt = pGMC303Bus->bus_read(pGMC303Bus->u8DevAddr, u8Addr, pu8Data, u8Len);
...
s8 gmc303_burst_write(u8 u8Addr, u8* pu8Data, u8 u8Len){
	...
	if(pGMC303Bus == NULL){
		...
		comRslt = pGMC303Bus->bus_write(pGMC303Bus->u8DevAddr, u8Addr, pu8Data, u8Len);
		if(comRslt < u8Len) comRslt = -1;
	}
